CREATE OR REPLACE PACKAGE BODY APP_DISCOUNT_TELCO.PKG_APP_CREATE_CUSTOMER_SERVICE AS
/****************************************************************************************/
	...
	PROCEDURE create_CUSTOMER_SERVICE(iCustomerService IN TYRC_CUSTOMER_SERVICES) IS 
		contract PKG_CREATE_CUSTOMER_SERVICES_BILLING.tyrcCUSTOMER_SERVICES;
	...
	BEGIN
    	...
    	PKG_CREATE_CUSTOMER_SERVICES_BILLING.insCUSTOMER_SERVICES(contract);
