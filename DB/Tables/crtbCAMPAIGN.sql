...
CREATE TABLE CAMPAIGN (
	    ID_CAMPAIGN NUMBER PRIMARY KEY NOT NULL,
...
/*  FIRST ALTER TABLE TO ASSIGN DEFAULT VALUE AT CAMPAIGN_JOIN_DATE*/
--  ASSIGN DEFAULT DAY LIKE CURRENT DATE
ALTER TABLE CAMPAIGN MODIFY CAMPAIGN_JOIN_DATE DEFAULT SYSDATE;
